 ...
 *
 */
public class ItemGetTask  extends AbsLogTask{

	public ItemGetTask(DCAgent dcAgent, PlayerLogModel model, BaseLogModel t) {
	...
	public void execute() {
		...
		dcAgent.itemGet(DCUserInfo.newBuilder().setAccountId(model.getAccountId())// 账号ID，必填
