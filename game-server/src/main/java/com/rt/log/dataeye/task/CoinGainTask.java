 ...
 *
 */
public class CoinGainTask extends AbsLogTask {

	public CoinGainTask(DCAgent dcAgent, PlayerLogModel model, BaseLogModel t) {
	...
	public void execute() {
		...
		dcAgent.coinGain(DCUserInfo.newBuilder().setAccountId(model.getAccountId())// 账号ID，必填
